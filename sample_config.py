...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "ZetsuScrapBot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "ZetsuScrapBot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/ZetsuScrapBot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/ZetsuScrapBot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Mᴀɴᴀɢᴇᴅ Wɪᴛʜ 👑 Bʏ @xflsdam")
